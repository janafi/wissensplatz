...
return get_result($sql);
 ...
 function edit($titel, $autor, $datum, $themenbereich, $publi_id){
    $sql = "UPDATE publikationen SET titel = '$titel', autor = '$autor', datum = '$datum', themenbereich = '$themenbereich' WHERE publikations_id=$publi_id;";
/* echo $sql; */
 return get_result($sql);
}
